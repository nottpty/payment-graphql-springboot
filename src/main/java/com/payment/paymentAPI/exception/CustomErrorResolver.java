...
import com.payment.paymentAPI.enums.ErrorTypes;
...
public class CustomErrorResolver extends DataFetcherExceptionResolverAdapter {
    ...
    protected GraphQLError resolveToSingleError(Throwable ex, DataFetchingEnvironment env) {
        ...
        if (t instanceof PaymentValidationException customException) {
            return new CustomGraphQLError(customException.getMessage());
        }
